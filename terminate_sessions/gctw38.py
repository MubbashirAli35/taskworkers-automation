...
cookies_path = '../cookies/cookies_gctw38.pkl'
...
with Chrome(executable_path='../chromedriver', options=options) as driver:
    ...
    for notebook in notebooks:
        ...
        if notebooks_data.at[i + 333, 'Status'] == 'Yes':
            ...
            try:
                ...
                print(notebooks_data.at[i + 333, 'Notebooks'] + 'already not in execution')
            ...
            print(notebooks_data.at[i + 333, 'Notebooks'] + ' terminated')

...
cookies_path = '../cookies/cookies_gctw12.pkl'
...
with Chrome() as driver:
    ...
    for notebook in notebooks:
        ...
        if notebooks_data.at[i + 99, 'Status'] == 'Yes':
            ...
            try:
                ...
                print(notebooks_data.at[i + 99, 'Notebooks'] + 'already not in execution')
            ...
            print(notebooks_data.at[i + 99, 'Notebooks'] + ' terminated')

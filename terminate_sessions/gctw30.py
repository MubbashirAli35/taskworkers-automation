...
with Chrome(executable_path='../chromedriver', options=options) as driver:
    ...
    for notebook in notebooks:
        ...
        if notebooks_data.at[i + 261, 'Status'] == 'Yes':
            ...
            try:
                ...
                print(notebooks_data.at[i + 261, 'Notebooks'] + 'already not in execution')
            ...
            print(notebooks_data.at[i + 261, 'Notebooks'] + ' terminated')

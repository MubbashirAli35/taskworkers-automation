...
cookies_path = '../cookies/cookies_gctw02.pkl'
...
with Chrome(executable_path='../chromedriver', options=options) as driver:
    ...
    for notebook in notebooks:
        ...
        if notebooks_data.at[i + 9, 'Status'] == 'Yes':
            ...
            try:
                ...
                print(notebooks_data.at[i + 9, 'Notebooks'] + 'already not in execution')
            ...
            print(notebooks_data.at[i + 9, 'Notebooks'] + ' terminated')

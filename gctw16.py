...
notebooks = ['https://colab.research.google.com/drive/1xvCbH3_JQY4qrIug6lTxAc3k-r3BdpH3',
...
with Chrome(executable_path='./chromedriver', options=options) as driver:
    ...
    for notebook in notebooks:
        ...
        if i == 0:
            print('gctw16E.ipynb loaded')
        elif i == 1:
            print('gctw16F.ipynb loaded')
        elif i == 2:
            print('gctw16G.ipynb loaded')
        elif i == 3:
            print('gctw16H.ipynb loaded')
        else:
            print('gctw16I.ipynb loaded')
        ...
        if i == 0:
            print('gctw16E.ipynb running')
        elif i == 1:
            print('gctw16F.ipynb running')
        elif i == 2:
            print('gctw16G.ipynb running')
        elif i == 3:
            print('gctw16H.ipynb running')
        else:
            print('gctw16I.ipynb running')

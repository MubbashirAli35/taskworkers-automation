...
with Chrome(options=options) as driver:
    ...
    time.sleep(2)
    email_box.send_keys('gctaskworker16@gmail.com')
    print('Email for gctw16 entered')
    ...
    for notebook in notebooks:
        ...
        if i == 0:
            print('gctw16E running')
        elif i == 1:
            print('gctw16F running')
        elif i == 2:
            print('gctw16G running')
        elif i == 3:
            print('gctw16H running')
        else:
            print('gctw16I running')

...
with Chrome(options=options) as driver:
    ...
    time.sleep(2)
    email_box.send_keys('gctaskworker11@gmail.com')
    print('Email for gctw11 entered')
    ...
    for notebook in notebooks:
        ...
        if i == 0:
            print('gctw11E running')
        elif i == 1:
            print('gctw11F running')
        elif i == 2:
            print('gctw11G running')
        elif i == 3:
            print('gctw11H running')
        else:
            print('gctw11I running')

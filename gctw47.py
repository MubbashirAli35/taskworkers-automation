...
# options.add_argument('--profile-directory=Profile 51')
...
notebooks_dict = {
    'gctw47a': 'https://colab.research.google.com/drive/1-AiHxM0kCU2mkv0zYuBvpKAOLqeG5je3',
    'gctw47b': 'https://colab.research.google.com/drive/1Q0IFaBGsk-I97Ig2pJaRROu9hfM8qAqr',
    'gctw47c': 'https://colab.research.google.com/drive/1AUzR2skPC-XynSyd6Yauu5gLuaQxY2V-',
    'gctw47d': 'https://colab.research.google.com/drive/1Qs369VzmuWv7akXYlIWUBNFNXZ5MsA25',
    'gctw47e': 'https://colab.research.google.com/drive/1qokzL-IJ130r1uuwbBaWLiX0O0nrN8P1',
    'gctw47f': 'https://colab.research.google.com/drive/12GKCxcWMNN_DsOg5qeDLrUF1LAIktYxN',
    'gctw47g': 'https://colab.research.google.com/drive/17Zr7xWRh4p__azqT_m70iWypFbi5skMq',
    'gctw47h': 'https://colab.research.google.com/drive/1bEqQ6uSKOt4xMA15gaGV7zLpu0bq0GHm',
    'gctw47i': 'https://colab.research.google.com/drive/1rvWqLDDp_wyWpxaJKUIXo4k1oHVmOk--'
}
...
with Chrome(executable_path='./chromedriver', options=options) as driver:
    ...
    # time.sleep(5)
    # pickle.dump(driver.get_cookies(), open('./cookies/cookies_gctw47.pkl', 'wb'), protocol=2)
    ...
    for i in range(9):
        ...
        # if True:
            ...
            print(notebooks_config.at[i + 414, 'Notebooks'] + ' Running')

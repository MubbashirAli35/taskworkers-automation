...
with Chrome(options=options) as driver:
    ...
    time.sleep(2)
    email_box.send_keys('gctaskworker20@gmail.com')
    print('Email for gctw20 entered')
    ...
    for notebook in notebooks:
        ...
        if i == 0:
            print('gctw20E running')
        elif i == 1:
            print('gctw20F running')
        elif i == 2:
            print('gctw20G running')
        elif i == 3:
            print('gctw20H running')
        else:
            print('gctw20I running')

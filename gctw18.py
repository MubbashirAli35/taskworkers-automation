...
with Chrome(options=options) as driver:
    ...
    time.sleep(2)
    email_box.send_keys('gctaskworker18@gmail.com')
    print('Email for gctw18 entered')
    ...
    for notebook in notebooks:
        ...
        if i == 0:
            print('gctw18E running')
        elif i == 1:
            print('gctw18F running')
        elif i == 2:
            print('gctw18G running')
        elif i == 3:
            print('gctw18H running')
        else:
            print('gctw18I running')

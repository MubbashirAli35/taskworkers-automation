...
with Chrome(options=options) as driver:
    ...
    time.sleep(2)
    email_box.send_keys('gctaskworker7@gmail.com')
    print('Email for gctw07 entered')
    ...
    for notebook in notebooks:
        ...
        if i == 0:
            print('gctw07E running')
        elif i == 1:
            print('gctw07F running')
        elif i == 2:
            print('gctw07G running')
        elif i == 3:
            print('gctw07H running')
        else:
            print('gctw07I running')

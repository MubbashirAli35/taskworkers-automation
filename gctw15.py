...
with Chrome(options=options) as driver:
    ...
    time.sleep(2)
    email_box.send_keys('gctaskworker15@gmail.com')
    print('Email for gctw15 entered')
    ...
    for notebook in notebooks:
        ...
        if i == 0:
            print('gctw15E running')
        elif i == 1:
            print('gctw15F running')
        elif i == 2:
            print('gctw15G running')
        elif i == 3:
            print('gctw15H running')
        else:
            print('gctw15I running')

...
notebooks = ['https://colab.research.google.com/drive/1EXgR2uOgACrDYmBg_JcyD3FELDNBbB2C',
...
with Chrome(executable_path='./chromedriver', options=options) as driver:
    ...
    for notebook in notebooks:
        ...
        if i == 0:
            print('gctw15E.ipynb loaded')
        elif i == 1:
            print('gctw15F.ipynb loaded')
        elif i == 2:
            print('gctw15G.ipynb loaded')
        elif i == 3:
            print('gctw15H.ipynb loaded')
        else:
            print('gctw15I.ipynb loaded')
        ...
        if i == 0:
            print('gctw15E.ipynb running')
        elif i == 1:
            print('gctw15F.ipynb running')
        elif i == 2:
            print('gctw15G.ipynb running')
        elif i == 3:
            print('gctw15H.ipynb running')
        else:
            print('gctw15I.ipynb running')

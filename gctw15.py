...
notebooks = ['https://colab.research.google.com/drive/12-DXpBGYr6T-7rsYF4oKmA7hbiCinx4ni',
...
with Chrome(executable_path='./chromedriver', options=options) as driver:
    ...
    driver.get(notebooks[4])    # Gets first notebook
    ...
    for i in range(9):
        ...
        if notebooks_config.at[i + 126, 'Status'] == 'Yes':
            ...
            print(notebooks_config.at[i + 126, 'Notebooks'] + ' Running')     # Logs on terminal that the Notebook is running

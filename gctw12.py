...
with Chrome(options=options) as driver:
    ...
    time.sleep(2)
    email_box.send_keys('gctaskworker12@gmail.com')
    print('Email for gctw12 entered')
    ...
    for notebook in notebooks:
        ...
        if i == 0:
            print('gctw12E running')
        elif i == 1:
            print('gctw12F running')
        elif i == 2:
            print('gctw12G running')
        elif i == 3:
            print('gctw12H running')
        else:
            print('gctw12I running')

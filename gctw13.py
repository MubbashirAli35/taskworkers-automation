...
with Chrome(options=options) as driver:
    ...
    time.sleep(2)
    email_box.send_keys('gctaskworker13@gmail.com')
    print('Email for gctw13 entered')
    ...
    for notebook in notebooks:
        ...
        if i == 0:
            print('gctw13E running')
        elif i == 1:
            print('gctw13F running')
        elif i == 2:
            print('gctw13G running')
        elif i == 3:
            print('gctw13H running')
        else:
            print('gctw13I running')

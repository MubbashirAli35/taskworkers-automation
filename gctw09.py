...
with Chrome(options=options) as driver:
    ...
    time.sleep(2)
    email_box.send_keys('gctaskworker9@gmail.com')
    print('Email for gctw09 entered')
    ...
    for notebook in notebooks:
        ...
        if i == 0:
            print('gctw09E running')
        elif i == 1:
            print('gctw09F running')
        elif i == 2:
            print('gctw09G running')
        elif i == 3:
            print('gctw09H running')
        else:
            print('gctw09I running')
